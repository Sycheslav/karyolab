...
Имя любого дочернего объекта строится иерархически: `<id-родителя>.<порядковый номер>`. По названию препарата, окраски, фото, метафазы или хромосомы всегда видно, к какому образцу они относятся. Полное описание - в [02_объекты_и_связи.md](02_объекты_и_связи.md#система-именования).
